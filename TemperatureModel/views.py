...
def Temperature_learning(request):
    ...
    return render(request, 'Temperature_learning.html',{'MIN_MSE':round(MIN_mse,2),'MAX_MSE':round(MAX_mse,2),'MIN_R2':round(MIN_r2,2),'MAX_R2':round(MAX_r2,2),'Random_state':round(random_state,2)})
